...
namespace dns
{
    ...
    {
        PacketData signature = getRandomSizeStream( 255 );
	...
	PacketData signature = getRandomStream( 0xffff );
	PacketData other     = getRandomStream( 0xffff );
	...
	PacketData other = getRandomStream( getRandom( 0xffff ) );
